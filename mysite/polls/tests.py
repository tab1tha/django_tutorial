...
def create_question(question_text, days):
    """
    create a question with the given 'question_text and publish the given number of 'days' offset to now (negative for past questions and positive for future questions)
    """
...
class QuestionIndexViewTests(TestCase):
    def test_no_question(self):
        ...
        """
        # to softcode links, we use reverse on the python side and {% url %} on the html side
        response = self.client.get(reverse("polls:index"))
        # in test env where db is empty, index page should successfully display error message.
